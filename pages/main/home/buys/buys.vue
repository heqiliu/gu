<template>
	<view class="content">
		<!-- #ifdef APP-PLUS -->
			...
			<cmd-nav-bar class="nav-bar" :fixed="false" back background-color="linear-gradient(to right, #EF9435, #E95E28)" title="买入开仓" font-color="#fff"></cmd-nav-bar>
		<!-- #endif -->
		<view class="buyMsg">
		...
		<view class="buyInfo">
			<view class="infoLeft">
				<input class="bit" type="number" v-model="missVal" maxlength="6" @input="bitListen" placeholder="请输入证券代码"/>
				<view class="thinkBox">
				...
				<view class="lis">
					<view class="left">选择到期日期</view>
					<view class="right cashType">
						<picker @change="cashPickerChange" :value="cashIndex" :range="cashArray">
							<view class="uni-input" v-model="cashIndex">100</view>
						</picker>
					</view>
				</view>
			<view class="lis">
				<view class="left">选择行权价</view>
				<view class="right cashType">
					<picker @change="cashPickerChange" :value="cashIndex" :range="cashArray">
						<view class="uni-input" v-model="cashIndex">100</view>
					</picker>
				...
				<input class="bit" type="text" v-model="missVal" maxlength="6" placeholder="合约名称">{{stockInfo.stockName }}</input>
				
			<view class="buyInPro">
				<radio-group @change="buyInChange" >
					<label>
						<view class="ct">
							<radio color="#FF6D28" value="1" checked="checked"/>认购
						</view>
					</label>
					<label>
						<view class="ct">
							<radio color="#FF6D28" value="2" />认沽
						</view>
					</label>
				</radio-group>
			</view>
			<view class="lis">
				<view class="left">选择委托方式</view>
				<view class="right cashType">
					<picker @change="cashPickerChange" :value="cashIndex" :range="cashArray">
						<view class="uni-input" v-model="cashIndex">100</view>
					</picker>
				...
				<view class="bbg" style="margin-top:10px">
					<view class="backRed bbgcon" @click="priceDelAdd('del')">-</view>
					<input class="bbi" type="number" value="" v-model="buyPrice" @blur="priceCheck" placeholder="委托价格"/>
					<view class="backRed bbgcon" @click="priceDelAdd('add')">+</view>
				</view>
				
				<view class="bbg" style="margin-top:10px" >
					<view class="backRed bbgcon" @click="numDelAdd('del')">-</view>
					<input class="bbi" type="number" value="" v-model="buyNum" @blur="numCheck" placeholder="委托数量"/>
			...
			<view class="infoRight">
				...
				<view class="xux" style="margin-top: 16upx;">
					<view class="maill">
					<view class="m1">涨停</view>
					<view class="m3">{{stockInfo.dailyLimit == undefined ? '0.00' : stockInfo.dailyLimit}}</view>
					</view>
					<view class="maill">
					<view class="m1">跌停</view>
					<view class="m3">{{stockInfo.downLimit == undefined ? '0.00' : stockInfo.downLimit}}</view>
					</view>
				</view>
			</view>

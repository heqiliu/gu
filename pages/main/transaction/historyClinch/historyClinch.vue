<template>
	<view class="content">
		...
		<cmd-nav-bar back background-color="linear-gradient(to right, #EF9435, #E95E28)" title="历史成交" font-color="#fff"></cmd-nav-bar>
		<!-- #endif -->
		...
		<view class="tb">
			...
			<view class="tbson td" v-for="(el,i) in buysData" :key="i" v-if="el.flag == 'S'">
			...
			<view class="tbson td" v-for="(el,i) in sellData" :key="i" v-if="el.flag == 'S'">
